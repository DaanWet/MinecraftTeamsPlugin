        ...
        if ((e.getAction() == Action.RIGHT_CLICK_BLOCK)){
            if (e.getClickedBlock().getState() instanceof Sign){
                ...
                if (sign.getLine(0).equalsIgnoreCase(ChatColor.AQUA + "Create Team")){
                    if (tHandler.getTeam(e.getPlayer().getUniqueId()) == null){
                        ConversationFactory cf = new ConversationFactory(plugin).withFirstPrompt(new TeamNamePrompt(e.getPlayer().getUniqueId(), plugin)).withLocalEcho(false).addConversationAbandonedListener(new ConversationAbondon(e, plugin));
                    ...
                    if (tHandler.getTeam(e.getPlayer().getUniqueId()) == null){
                        tHandler.joinTeam(sign.getLine(0).substring(2), e.getPlayer().getUniqueId());
                    ...
                    tHandler.exitTeam(e.getPlayer().getUniqueId());
                }
            }
        }
    }
